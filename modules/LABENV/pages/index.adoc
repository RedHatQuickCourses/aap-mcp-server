...
. **Search** for the catalog entry: **What's New in AAP 2.7: Automation Portal, MCP & EE Builder**.
+
image::1.png[]
...
=== RHDP Portal Links
- RedHat associates: [https://demo.redhat.com/,window=_blank]
- RedHat partners: [https://partner.demo.redhat.com/,window=_blank]
